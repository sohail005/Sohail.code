...
Replace the `public/images/avatar.jpeg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
...
<CodeBlock
  ...
  codes={[
    ...
    location: "Hydrabad/Telangana", // Expecting the IANA time zone identifier, e.g., 'Europe/Vienna'
...
<CodeBlock
  ...
  codes={[
    ...
    subline: "I'm Sohail, a Software Developer at FLY, where I craft intuitive user experiences. After hours, I build my own projects.",
    };`,
      language: "tsx",
      label: "src/app/resources/content.js",
    },
